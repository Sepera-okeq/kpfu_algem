...
**Определение.** Модулем вектора называется его длина. Если вектор ![](<../.gitbook/assets/image (19) (1) (1) (1).png>) задан прямоугольными координатами _a = (x,y,z)_, тогда:

![](<../.gitbook/assets/image (44) (1).png>)

**Определение.** Векторы ![](<../.gitbook/assets/image (52) (1) (1).png>) называются противоположными.
...
**Определение.** Пусть даны две точки ![](<../.gitbook/assets/image (50) (1) (1).png>) Тогда координаты вектора ![](<../.gitbook/assets/image (45) (1) (1).png>) вычисляются по следующей формуле:&#x20;

![](<../.gitbook/assets/image (70) (1) (1).png>)

**Расстояние между точками** ![](<../.gitbook/assets/image (55) (1) (1).png>)  равно:&#x20;
