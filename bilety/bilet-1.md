...
**Определение.** Векторы ![](<../.gitbook/assets/image (52) (1).png>) называются противоположными.
...
**Определение.** Пусть даны две точки ![](<../.gitbook/assets/image (50) (1) (1).png>) Тогда координаты вектора ![](<../.gitbook/assets/image (45) (1).png>) вычисляются по следующей формуле:&#x20;
